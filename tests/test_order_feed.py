...
class TestOrderFeed:
    ...
    def test_order_modal_open(self, driver, make_order):
    ...
    def test_history_orders_exists_in_order_feed(self, driver, make_order):
        main_page = MainPage(driver)
        login_page = LoginPage(driver)
    ...
    def test_complete_for_all_time_increase(self, driver, make_order):
        main_page = MainPage(driver)
        login_page = LoginPage(driver)
        order_feed_page = OrderFeedPage(driver)
    ...
    def test_complete_for_today_increase(self, driver, make_order):
        main_page = MainPage(driver)
        login_page = LoginPage(driver)
        order_feed_page = OrderFeedPage(driver)
    ...
    def test_order_in_progress(self, driver, make_order):
        main_page = MainPage(driver)
        login_page = LoginPage(driver)
        order_feed_page = OrderFeedPage(driver)
